...
class Model(BaseModel):
    ...
    def inference(self, data):
        ...
        if "inerf_data" in data:
            output = self.render_image(data["pose"], data["intr"], stratified=False, inerf_data=data['inerf_data'])
        else:
    ...
    def render_image(self, pose, intr, stratified=False, inerf_data=None):
